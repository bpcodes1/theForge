    ...
    <>
      ...
      <section className="section section--deep" id="floors" style={{ borderBottom: '4px solid var(--cherry)', paddingTop: '3rem', overflow: 'hidden' }}>
        ...
        <div className="floors-grid">
          <Link to="/ground-floor" className="floor-card">
            <img src="/images/ground-floor.jpg" alt="Ground Floor" />
          ...
          <Link to="/womens-collective" className="floor-card">
            <img src="/images/womens-collective.jpg" alt="Women's Collective" />
            <div className="floor-card-body">
          ...
          <Link to="/cellar-54" className="floor-card">
            <img src="/images/cellar54.jpg" alt="Cellar 54 — Lower Level" />
            <div className="floor-card-body">
          ...
          <Link to="/anthem" className="floor-card">
            <img src="/images/anthem.jpg" alt="Anthem — Third Floor" />
            <div className="floor-card-body">
      ...
      <section className="section section--deep" id="social" style={{ paddingTop: '3rem' }}>
        ...
        <div className="social-grid">
          {[
            { src: '/images/social-1.jpg', alt: 'Vendor market at The Forge', cap: 'Our makers bring it every time. Market days hit different.', likes: '412' },
            { src: '/images/gallery-1.jpg', alt: "Women's Collective boutique", cap: "Second floor is doing something they can't quite explain.", likes: '356' },
            { src: '/images/ladies-room-3.jpg', alt: 'Ladies Room', cap: 'People come for the vibe. They stay for the bathroom.', likes: '891' },
            { src: '/images/clink.jpg', alt: 'Clink! bar', cap: 'Cherry blossoms and champagne on the second floor.', likes: '638' },
            { src: '/images/social-2.jpg', alt: 'The Forge events', cap: 'The wins here look good in frames.', likes: '284' },
            { src: '/images/gallery-6.jpg', alt: 'Ground floor dining', cap: 'Dining that makes a night into a memory.', likes: '503' },
          ].map((p, i) => (
